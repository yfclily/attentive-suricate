...
(1) `dat1`: grain harvest for north america + several long and wide versions of this dataset. Examine objects created.  
...
(2) `dat2`: ncome/education census data for the US and its long version. Examine objects created.  
