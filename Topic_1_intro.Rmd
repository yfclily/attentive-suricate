...
>>>>>>> 2de660cb44c10d18ab7de92b8c70a6c187f987e4
---
...
The aim of this course is to get familiar with the programming language R. We will explore together the advantages of using R language for formatting reports,  preparing presentations, exploring and analyzing data creating and sharing project. We will start from scratch, i.e. downloading R and installing it on your computer. I will quickly introduce you RStudio, Rmarkdown, and GitHub that you are requested to use at the beginning. 
...
**Class format and philosophy:** The aim is not to know everything and test you 
