...
Create an account on [GitHub](https://github.com/). You can **create your first repository** to later connect it to your RStudio.
...
+ changes needs to be 'commit' (prepared) and 'push' to GitHub in order to be synchronized
...
Once set up you can travel between
...
Your job will be to render this file in RStudio and to review it. Each  week, you will prepare a short example based on the previous class. A presenter will be randomly selected (see below) to illustrate his example at the beginning of the class (be on time).   
...
edit the lesson webpage for the day that you sign up to lead class. We have provided an outline, but you will need to supply the example code and text describing what it does.
