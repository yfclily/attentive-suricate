...
> *<span style="color: green"> **Challenge**: the data set `rairuoho`provides growth data for 8 days in different treatments. Reformat the table in order to have the `day` as a variable with 6 levels. Current variables are given as:</span>* 
